...
public class SystemController {
    ...
    @PostMapping("/list")
    public RoomResponse addStudent(@RequestBody Student student, @RequestBody String roomName){
        return systemService.addStudent(student, roomName);
    }

    @DeleteMapping("/list")
    public void deleteStudent(@RequestBody Integer stdId, @RequestBody String roomName){
        systemService.deleteStudent(stdId, roomName);
    }

    @PutMapping("/list")
    public RoomResponse updateStudent(@RequestBody Student student, @RequestBody String roomNamee){
